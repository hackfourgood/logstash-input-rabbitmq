...
Does not work| <<plugins-{type}s-{plugin}-ssl_certificate_password>> |<<string,string>>|No
Does not work| <<plugins-{type}s-{plugin}-ssl_certificate_path>> |a valid filesystem path|No
Does not work| <<plugins-{type}s-{plugin}-ssl_version>> |<<string,string>>|No 
